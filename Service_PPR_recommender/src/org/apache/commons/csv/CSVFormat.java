...
public final class CSVFormat implements Serializable {
     ...
     *
     * @param ignoreEmptyLines the empty line skipping behavior, <tt>true</tt> to ignore the empty lines between the records,
     ...
     *
     * @param ignoreSurroundingSpaces the trimming behavior, <tt>true</tt> to remove the surrounding spaces, <tt>false</tt> to leave the
     *                                spaces as is.
